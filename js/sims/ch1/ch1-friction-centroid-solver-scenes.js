...
const scenes = [
  {
    ...
    initialState: { primary: { x: 326, y: 254 }, force: 88, load: 140, mu: 0.38, trail: [] },
  ...
  },
  {
    ...
    initialState: { primary: { x: 294, y: 252 }, force: 94, load: 150, mu: 0.48, trail: [] },
  ...
  },
  {
    ...
    initialState: { primary: { x: 378, y: 230 }, alpha: 19, force: 92, load: 130, mu: 0.46, trail: [] },
  ...
  },
  {
    ...
    initialState: { primary: { x: 362, y: 222 }, alpha: 16, force: 88, load: 120, mu: 0.42, trail: [] },
