...
(function(root) {
  ...
  Reg.register('ch2-3-2', function(container) {
    ...
    function draw() {
      const gearOmega2 = -omega1 * params.r1 / params.r2;
      const beltOmega2 = omega1 * params.r1 / params.r2;
      const g2 = G2();
      ...
      const beltA = { x: P1.x, y: P1.y + params.r1 };
      const beltB = { x: P2.x, y: P2.y + params.r2 };
      const beltC = { x: P1.x, y: P1.y - params.r1 };
      const beltD = { x: P2.x, y: P2.y - params.r2 };
