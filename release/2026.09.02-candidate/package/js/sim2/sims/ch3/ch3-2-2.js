...
(function(root) {
  ...
  Reg.register('ch3-2-2', function(container) {
    ...
    function reset() { t = 0; vData = []; shell.resetClock(); draw(); }
    function draw() {
      ...
      panel.setReadout([
        ...
        { key: 'x', label: 'x(t):', value: x.toFixed(1) + ' m' },
    ...
    const panel = shell.setTheory({
      ...
      observe: 'Bấm ▶. x(t), v(t) luôn tăng; vật chạy lặp qua làn hiển thị để không đứng hình ở mép phải.'
    });
