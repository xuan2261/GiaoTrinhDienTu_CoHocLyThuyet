...
(function(root) {
  ...
  Reg.register('ch1-6-3', function(container) {
    ...
    function render2() {
      ...
      panel.setReadout([
        { key: 'plateArea', label: 'A tấm:', value: plate.area.toFixed(1) },
        { key: 'holeArea', label: '-A lỗ:', value: '-' + holeArea.toFixed(2) },
        { key: 'Cx', label: 'Cx:', value: c.cx.toFixed(2) },
        { key: 'Cy', label: 'Cy:', value: c.cy.toFixed(2) }
      ]);
    }
    ...
    const handle = shell.addHandle({ x: hole.cx, y: hole.cy }, {
      fill: Pal.handle,
      a11y: { label: 'Tâm lỗ khoét', axis: 'both' },
