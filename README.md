...
- Candidate reproducible hiện tại: `release/2026.08.29-candidate/`, 372 files, standalone ZIP SHA-256 `f38996d8614f73dc7355124606c99bf983d01171e00dd0adc0f373a7b762ee0e`; QTI 3/Common Cartridge derivatives nằm trong `derivatives/`. Đây chưa phải final institutional acceptance: independent academic signoff, independent accessibility review, independent candidate smoke review và Word round-trip vẫn bị chặn. Candidate `2026.08.25`, `2026.08.21` và các bản `20260816`, `20260812`, `20260701` được giữ nguyên làm lịch sử.
