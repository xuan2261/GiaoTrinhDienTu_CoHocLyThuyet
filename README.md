...
| `js/sim-route-renderer-registry.js` + `js/sim-route-behavior-registry.js` | Strict route renderer/behavior contracts; 58 routes phải có renderer function riêng |
...
| `js/sims/ch*/` | Route modules, scene catalogs, 58 route renderers, và behavior contracts theo chương |
...
- Bộ simulation professional dùng chung `SimProfessionalLab` cho 58 route; adapters chỉ giữ route id và manifest metadata.
