...
| `js/sim3/sims/` | Pilot adapters cho `ch2-2-2`, `ch2-3-2`, `ch2-4-4`, `ch3-5-3`, `ch3-6-2`; Sim2 vẫn là mặc định, fallback về 2D khi WebGL fail |
...
Sim3 là pilot 3D tùy chọn cho 5 route Sim2: `ch2-2-2`, `ch2-3-2`, `ch2-4-4`, `ch3-5-3`, `ch3-6-2`. Luồng mount vẫn giữ nguyên contract `window.SIM_MAP[pageId] -> factory(container) -> { dispose }`; Sim2 SVG-first tiếp tục là mặc định, còn Sim3 chỉ được bật theo route và chỉ khi WebGL chạy ổn.
...
| Adapters | `js/sim3/sims/ch2-2-2-3d.js`, `ch2-3-2-3d.js`, `ch2-4-4-3d.js`, `ch3-5-3-3d.js`, `ch3-6-2-3d.js` |
| Fallback | Nếu WebGL fail, route quay về 2D và hiện thông báo tiếng Việt |
| Phạm vi | Pilot 5 route, chưa rollout sang toàn bộ 25 route |

Visual artifacts cho batch mới được lưu dưới `plans/260603-1858-sim3-route-candidate-audit-and-rollout-plan/visuals/` để đối chiếu nội bộ.
