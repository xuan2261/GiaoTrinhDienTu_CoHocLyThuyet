# Review status and claim limitations

- Academic acceptance remains incomplete. Status: `blocked`.
- Accessibility independent review remains incomplete. Status: `blocked`.
- Word/DOCX round-trip remains incomplete. Status: `blocked`.
- Independent standalone smoke remains incomplete. Status: `blocked`.
