...
- Post-review DeCuong fixes complete: CH2 visible `x=0` checker output preserved, CH3 collision solver/renderer preserve zero `v1`/`v2`/`e`, CH3 visible English labels localized, `ch1-7-1` screenshot evidence regenerated, and `npm run test:sim:release` PASS.
