...
| 08 | [RC2 RC6 Animation Density And Theme Parity](./phase-08-rc2-rc6-animation-density-theme-parity.md) | Partial | Impulse flash (ch3-6-2) + preset gallery (ch1-2-3, ch1-1-3, ch1-2-1) shipped. Trail buffer (ch2-1-1), autoplay (ch3-3-1), light theme parity (RC6) still pending. |
